##We will use InverseLinfty in this code to derive Inverse Sample Covairance Matrix.
#
...
SSLasso1<- function (X, y, M,alpha=0.05, lambda = NULL, mu = NULL, intercept = TRUE, 
  ...
  #sqrt(diag(A[(pp-p+1):pp,(pp-p+1):pp]))
